...
$full_install_dir = Resolve-Path $install_dir

Write-Host "Installing in $full_install_dir"

$yt_dlp_url = "https://github.com/yt-dlp/yt-dlp/releases/latest/download/yt-dlp.exe"
Invoke-WebRequest -Uri $yt_dlp_url -OutFile "$full_install_dir/yt-dlp.exe"
...
Move-Item -Path "$tmp_dir/platform-tools/*" -Destination $full_install_dir
